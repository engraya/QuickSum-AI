...
function LandingText() {
  return (
    ...
    <h1 className="animate-typing bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent mx-auto max-w-4xl font-display text-3xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl">
      Revolutionize Your Insurance
      <span className="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent relative whitespace-nowrap text-white-600 dark:text-gray-300">Operations</span>
